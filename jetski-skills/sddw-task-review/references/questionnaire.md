...
If a finding's severity is ambiguous, present options:
1. "Blocker — [why it must be fixed before proceeding]"
2. "Major — [why it should be fixed]"
3. "Minor — [why it's optional]"
