...
**Output rule:** Always output the full findings as text FIRST. Then ask the approval question. Never put the findings list inside the question — the user must be able to read the content before answering.
...
- SHALL output full findings as text before asking the approval question — never embed the list inside the question
