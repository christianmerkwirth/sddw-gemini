...
name: sddw-implement
description: >
  Implement a single task from the design spec following TDD, commit, and
  deviation handling protocols. Use when the user says "sddw implement",
  "implement task N", "execute task", or wants to code a specific task
  from the sddw pipeline. Requires design.md and task files to exist.
