...
Present the task table as context, then present each pending task as an option:
...
> "**Recommendation:** Clear your context before starting the next task. Each task execution is isolated — a fresh context avoids accumulated noise from this implementation."
