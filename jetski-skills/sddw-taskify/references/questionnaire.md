...
Present the proposed task breakdown. Ask user to confirm or adjust.
...
Generate the task files at `.sddw/<feature-name>/design/tasks/task-<N>-<slug>.md` in the hybrid format defined in the spec template.
